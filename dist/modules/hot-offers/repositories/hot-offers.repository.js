...
exports.HotOffersRepository = void 0;
...
class HotOffersRepository {
    ...
    async categorySlugExists(slug, exceptId) {
    ...
    async softDeleteCategory(id, freedSlug) {
    ...
    // ---- feedback pages ----
    findFeedbackPageByCategorySlug(slug, publishedOnly) {
    ...
    upsertFeedbackPage(categoryId, data) {
    ...
    findOfferBySlug(slug, publishedOnly) {
        return this.prisma.offer.findFirst({
            where: {
                slug,
                deletedAt: null,
    ...
    async offerSlugExists(slug, exceptId) {
    ...
    async softDeleteOffer(id, freedSlug) {
    ...
    async countUniqueSessions(since) {
    ...
    async topCategories(since, limit) {
        return this.prisma.$queryRaw `
    ...
    listSubmissionsByUser(userId, params) {
        const where = { userId };
        return Promise.all([
     ...
     */
    async approveSubmission(id, reviewerId) {
        return this.prisma.$transaction(async (tx) => {
            ...
            await tx.walletTransaction.create({
                data: {
                    walletId: wallet.id,
                    type: "CREDIT",
                    amount: new client_1.Prisma.Decimal(submission.rewardAmount),
    ...
    setReviewOutcome(id, status, reviewerId, reviewNote) {
        return this.prisma.offerSubmission.update({
            where: { id },
    ...
    async findDuplicateImage(hash, exceptSubmissionId) {
    ...
    async countDistinctParticipants(offerId) {
    ...
    countImagesForUserOfferSince(userId, offerId, since) {
...
exports.HotOffersRepository = HotOffersRepository;
//# sourceMappingURL=hot-offers.repository.js.map